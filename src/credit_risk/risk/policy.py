...
The approve/decline cut-off is *derived*, not chosen. The original code used
hardcoded probability bands of 0.3 and 0.6 with no stated justification.

Here the cut-off is the PD at which expected margin equals expected loss:
...
from credit_risk.risk.grades import assign_grade


class Decision(StrEnum):
    APPROVE = "APPROVE"
    REFER = "REFER"  # to a human underwriter
    DECLINE = "DECLINE"
