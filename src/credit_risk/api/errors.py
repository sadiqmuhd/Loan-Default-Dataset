"""Exception handlers with correct HTTP semantics.

The original API mapped every prediction failure to 400 Bad Request and
interpolated the raw exception text into the response body, which is both wrong
semantically and an information-disclosure issue.
