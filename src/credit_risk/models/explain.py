...
Why this exists beyond "explainability is nice": under ECOA / Regulation B
(12 CFR 1002.9) a declined applicant is entitled to the *specific principal
reasons* for the decision. A credit model that cannot produce reason codes
cannot lawfully be used to decline anyone. So this is a functional requirement,
