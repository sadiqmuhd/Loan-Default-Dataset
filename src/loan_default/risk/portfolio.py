...
from loan_default.risk.expected_loss import expected_loss
from loan_default.risk.grades import assign_grades, grade_scale
...
def aggregate(
    ...
    return PortfolioSummary(
        ...
        grade_distribution=cast(
            list[dict[str, Any]], by_grade.reset_index().to_dict(orient="records")
        ),
